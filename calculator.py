...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.btn11 = CTkButton(self, text='÷', font=("LCD Mono", 25), text_color='white', fg_color='#fc03a9', width=50, height=50, command=self.dilenna)
        self.btn12 = CTkButton(self, text='×', font=("LCD Mono", 25), text_color='white', fg_color='#fc03a9', width=50, height=50, command=self.mnozenna)
        self.btn13 = CTkButton(self, text='-', font=("LCD Mono", 25), text_color='white', fg_color='#fc03a9', width=50, height=50, command=self.minus)
        ...
        self.btn2.place(x=80, y=180)
        self.btn3.place(x=140, y=180)
        self.btn4.place(x=20, y=245)
        self.btn5.place(x=80, y=245)
        self.btn6.place(x=140, y=245)
        self.btn7.place(x=20, y=310)
        self.btn8.place(x=80, y=310)
        self.btn9.place(x=140, y=310)
        self.btn10.place(x=20, y=370)
        self.btn11.place(x=220, y=180)
        self.btn12.place(x=220, y=245)
        self.btn13.place(x=220, y=310)
        self.btn14.place(x=220, y=370)
        self.btn15.place(x=20, y=120)
        self.btn16.place(x=220, y=120)
    ...
    def dorin(self):
        ...
        if c == "+":
            self.entry.configure(placeholder_text=float(a)+float(b))
        elif c == '-':
